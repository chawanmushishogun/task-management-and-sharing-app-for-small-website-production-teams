...
export const INITIAL_TASKS: Task[] = [
  ...
  },
  {
    ...
    tags: [],
    subtasks: [],
    comments: [{ id: "c1", authorId: "m1", text: "お問い合わせページのフォーム設計も含めてください", time: "3日前" }],
    note: "",
  },
  {
    id: "p1-5",
  ...
  },
  {
    ...
    tags: [],
    subtasks: [
      { id: "s1", name: "デザイン作成", done: true },
      { id: "s2", name: "クライアント確認", done: false },
    ],
    comments: [],
    note: "",
  },
  {
    ...
    projectId: "p1",
    section: "デザイン",
    name: "favicon / touchicon / og:image",
    assigneeId: "m3",
    endDate: "2026-08-18",
    startDate: null,
    status: "todo",
  ...
  },
  {
    ...
    projectId: "p1",
    section: "メタタグ系入力",
    name: "メタタグ（description / keywords）",
    assigneeId: "m2",
    endDate: "2026-09-08",
    startDate: null,
    status: "todo",
  ...
  },
  {
    ...
    tags: [],
    subtasks: [],
    comments: [{ id: "c2", authorId: "m1", text: "会社概要ページの原稿を先にもらえると助かります", time: "1日前" }],
    note: "",
  },
  {
    id: "p1-25",
  ...
  },
  {
    ...
    tags: [],
    subtasks: [
      { id: "s3", name: "トップ・商品一覧", done: true },
      { id: "s4", name: "商品詳細・カート", done: false },
    ],
    comments: [],
    note: "",
  },
  ...
  },
  {
    ...
    tags: [],
    subtasks: [],
    comments: [{ id: "c3", authorId: "m1", text: "サーバ移管が必要か確認中です", time: "2日前" }],
    note: "",
  },
  // 公開
  {
